...
if (isset($_GET['filter'])) {
	...
	switch ($filter) {
		...
		<div class="invoices">
			...
			<table>
				<tr>
					<td colspan="5" id="filter">
						<button name="btn"><a href="?modules=invoices&action=manage&filter=0">All</a></button>
						<button name="btn"><a href="?modules=invoices&action=manage&filter=1">Pending</a></button>
						<button name="btn"><a href="?modules=invoices&action=manage&filter=2">Approved</a></button>
						<button name="btn"><a href="?modules=invoices&action=manage&filter=3">Completed</a></button>
						<button name="btn"><a href="?modules=invoices&action=manage&filter=4">Cancelled</a></button>
					</td>
